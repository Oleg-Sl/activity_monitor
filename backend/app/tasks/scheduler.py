...
# # lock = Lock()  # Для предотвращения повторного запуска задачи
...
# # def task_wrapper(task_id: str, task_func: Callable, *args, **kwargs):
# #     """
# #     Обертка для задачи, которая предотвращает ее повторный запуск до завершения.
# #     """
# #     with lock:
